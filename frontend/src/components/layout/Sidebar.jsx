            ...
            <NavLink
              ...
              className={({ isActive }) => `
                ...
                ${isActive 
                  ...
                  : `text-gray-300 hover:bg-gray-800 hover:text-white border-l-4 ${isOpen ? 'border-transparent' : 'border-[#1A1D23]'}` // Fake invisible border trick so UI doesn't bounce
                }
              `}
            >
